...
public class Thursday extends Fragment {
    ...
    public void onStart() {
        ...
        ListView listView = (ListView) getView().findViewById(R.id.thursday_list_view);
        TextView noClassesTextView = (TextView) getView().findViewById(R.id.thursday_no_classes);

        if (DataStore.getClassesLinkedListOfDay(Calendar.THURSDAY) != null) {

            noClassesTextView.setVisibility(View.GONE);

            TimetableList listAdapter = new TimetableList(getContext(), DataStore.getClassesLinkedListOfDay(Calendar.THURSDAY));
